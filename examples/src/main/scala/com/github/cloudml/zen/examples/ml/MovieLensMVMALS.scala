...
object MovieLensMVMALS extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("MVMALS") {
      head("MovieLensMVMALS: an example app for MVMALS.")
  ...
  def run(params: Params): Unit = {
    ...
    SparkHacker.gcCleaner(60 * 10, 60 * 10, "MovieLensMVMALS")
    ...
    val lfm = new MVMALSRegression(trainSet, views, rank, storageLevel)
    var iter = 0
